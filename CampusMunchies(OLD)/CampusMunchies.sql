...
VALUES
    ('ORD0000001','0123456788', '0123456787', '2023-10-11', 'Delivery', 'Processing','COD', N'Deliver to the back entrance', 33.96);
	INSERT INTO [Order] (ord_id,cus_phone, emp_phone, ord_date, ord_type, ord_status, ord_pay, ord_note, ord_total)
VALUES
    ('ORD0000002','0123456787', '0123456789', '2023-10-12', 'Takeout', 'Delivered','COD', N'Dont include any plastic cutlery', 10.99);
	INSERT INTO [Order] (ord_id,cus_phone, emp_phone, ord_date, ord_type, ord_status, ord_pay, ord_note, ord_total)
VALUES
    ('ORD0000003', '0123456786', '0123456785', '2023-10-13', 'Delivery', 'Delivered','COD', N'Please add extra ketchup packets', 6.99)
	INSERT INTO [Order] (ord_id,cus_phone, emp_phone, ord_date, ord_type, ord_status, ord_pay, ord_note, ord_total)
VALUES
