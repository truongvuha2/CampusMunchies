                        ...
                        <ul id="main-menu">
                            ...
                            <li><a style="color:#c21010">Hi, ${name}</a>
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="/customer/logout">Logout <ion-icon style=" display: inline-block; vertical-align: middle; margin-left: 2px; font-size: 24px;" name="log-out-outline"></ion-icon></a></li>
                                </ul>
                            </li>
                        </ul>
                    </nav>
