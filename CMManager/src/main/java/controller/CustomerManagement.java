...
public class CustomerManagement extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Customer> listCustomerBlack = new ArrayList<Customer>();
        try {
            listCustomerMain = customerDao.getCusListManagement();
            request.setAttribute("listCusM", listCustomerMain);
            listCustomerHonor = customerDao.getHonorListManagement();
            request.setAttribute("listCusH", listCustomerHonor);
            listCustomerBlack = customerDao.getBlackListManagement();
            request.setAttribute("listCusB", listCustomerBlack);
