                    ...
                    <ul>
                        <li>
                            ...
                            <select class="select-box">
                                ...
                                <option value>Frided Food</option>
            ...
            <aside>
                <div class="sidebar">
                    ...
                    <ul class="side-menu">
                        ...
                        <li><a href="customerManagement.jsp"><i class='bx bxs-user-account'></i>
                                Customer</a>

                           

                        </li>
                        <li><a href="employeeManagement.jsp"><i class='bx bxs-user-detail'></i>
                                Employee</a>
